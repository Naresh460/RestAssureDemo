...
public class GoogleSheets {
	...
	static final String existingSpreadSheetID = "14y_GO1E_7pYKYDz-y5BURygebP50FzA";
	static final String credentialPath = "./credentials.json";
	static ValueRange response;
	static String testDataSheetName = "UTI";
	...
	public static void authorize() throws IOException {
		credential = GoogleCredentials.fromStream(Files.newInputStream(Paths.get(credentialPath)))
...
//				GsonFactory.getDefaultInstance(), credential).setApplicationName("My Project 79975").build()
//				.spreadsheets();
//	}
